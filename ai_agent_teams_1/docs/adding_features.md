...
Run with: `uv run ai_agent_teams_1 cmd my-command --name test`
...
# Or use CLI
uv run ai_agent_teams_1 db migrate -m "Add notifications table"
uv run ai_agent_teams_1 db upgrade
```
