...
from app.email.providers.base import EmailMessage, EmailProvider, SendResult
...
class EmailService:
    ...
    async def send_welcome(self, *, to: str, name: str, login_url: str) -> SendResult:
        return await self.send(
            ...
            to=to,
            context={"name": name, "login_url": login_url, "app_name": "ai_agent_teams_1"},
        )
